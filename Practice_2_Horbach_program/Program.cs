...
namespace Practice_2_Horbach_Program
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            string path = @"C:\Users\Arina Gorbach\Downloads\results_2010.json";
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games
               .Where(game => (game.Home_team == "France" && game.Date.Year == 2021 && (game.Country == "France") && game.Home_score == game.Away_score))
               .OrderBy(game => game.Date)
               .ToList();   // Корегуємо запит !!!
            ...
            foreach (var game in selectedGames)
            {
                Console.WriteLine($"{game.Date:dd.MM.yyyy} {game.Home_team} - {game.Away_team}, Score: {game.Home_score} - {game.Home_score}, Country: {game.Country}");
            }
        }
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                .Where(game => (game.Away_team == "Germany" && game.Date.Year >= 2018 && game.Date.Year <= 2020 && game.Away_score < game.Home_score))
                .OrderBy(game => game.Date)
                .ToList();  // Корегуємо запит !!!
            ...
            foreach (var game in selectedGames)
            {
                string opponent = game.Home_team == "Germany" ? game.Away_team : game.Home_team;
                Console.WriteLine($"{game.Date:dd.MM.yyyy} {opponent} - Germany, Score: {game.Home_score} - {game.Away_score}, Country: {game.Country}");
            }
        }
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games
               .Where(game => game.Tournament == "UEFA Euro qualification" && (game.City == "Kyiv" || game.City == "Kharkiv") && (game.Home_team == "Ukraine" || game.Away_team == "Ukraine") && (game.Home_team == "Ukraine" ? game.Home_score > game.Away_score : game.Away_score > game.Home_score))
               .OrderBy(game => game.Date)
               .ToList();  // Корегуємо запит !!!
            ...
            foreach (var game in selectedGames)
            {
                string result = game.Home_team == "Ukraine" ? "Win" : "Loss";
                Console.WriteLine($"{game.Date:dd.MM.yyyy} {game.Home_team} - {game.Away_team}, Score: {game.Home_score} - {game.Away_score}, Country: {game.Country}");
            }
        }
        ...
        static void Query7(List<FootballGame> games)
        {
            ...
            {
                if (game.Date.Year == 2023 && ((game.Home_team == "Ukraine" && game.Home_score > game.Away_score) || (game.Away_team == "Ukraine" && game.Away_score > game.Home_score)))
                {
                    g = game;
                    break;
                }
            ...
            if (g != null)
            {
                string opponent = g.Home_team == "Ukraine" ? g.Away_team : g.Home_team;
                Console.WriteLine($"{g.Date:dd.MM.yyyy} {opponent} - Ukraine, Score: {g.Home_score} - {g.Away_score}, Country: {g.Country}");
            }
            else
            {
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            var selectedGames = games
               .Where(game => game.Date.Year == 2012 && (game.Country == "Ukraine") && game.Tournament == "UEFA Euro")
               .Select(game => new
               {
        ...
        static void Query10(List<FootballGame> games)
        {
            ...
            var selectedGames = games
                 .Where(game => game.Tournament == "Gold Cup" && game.Date.Month == 7 && game.Date.Year == 2023)
                 .Skip(4)
                 .Take(6)
                 .ToList();   // Корегуємо запит !!!
